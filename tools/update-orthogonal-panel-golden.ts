...
const outputPath = fileURLToPath(new URL("../tests/golden/orthogonal-panel-matrix.json", import.meta.url));
...
await writeFile(
  outputPath,
  `${JSON.stringify({ schemaVersion: "1.0", matrixId: "orthogonal-panel-current", cases }, null, 2)}\n`,
  "utf8",
);
