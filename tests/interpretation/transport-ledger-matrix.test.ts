...
import { M5LiveOpenAITransport } from "../../tools/m5-live-openai-adapter.js";

const price = {
  id: "matrix-price-snapshot",
...
function harness(
  ...
  const orchestrator = new GeneratedProjectOrchestrator({
    ...
    appendAttempt: (attempt: LiveCallAttempt) => {
      ledger = appendAttempt(ledger, "m5-transport-ledger-matrix", attempt);
