...
export const GENERATION_OPENAI_MODEL = "gpt-5.6-terra" as const;
export const GENERATION_OPENAI_MAX_RETRIES = 0 as const;
export const GENERATION_TERRA_PRICE = {
...
function estimatedCost(input: {
  ...
  return Number((
    uncachedInput * GENERATION_TERRA_PRICE.uncachedInputUsdPerMillion / 1_000_000 +
    input.cachedInputTokens * GENERATION_TERRA_PRICE.cachedInputUsdPerMillion / 1_000_000 +
    input.outputTokens * GENERATION_TERRA_PRICE.outputUsdPerMillion / 1_000_000
  ).toFixed(8));
}
