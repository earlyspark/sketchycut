...
export type CurrentFixtureScenario = {
  ...
  coLocatedAccessAperture?: boolean;
...
export const CURRENT_FIXTURE_SCENARIOS: readonly CurrentFixtureScenario[] = Object.freeze([
  ...
  fixture({ id: "modified-fixed-aperture-enclosure", brief: "Make a fixed-top primary enclosure with a circular top opening, registered lattice walls, and flexible kerf-bent corners.", briefDigest: "e1e72bafeb83761dce8af0b5efc72edc7d7dcfe4363fed41bb991f55f7cf1e6f", access: "covered", mechanism: "fixed-top-frame", surface: false, unsupportedCompoundMotion: false, unsupportedFlexureCorners: true, coLocatedAccessAperture: true, invalidOutput: false }),
  ...
  const items = [
    item({
      ...
      atoms: [{
        ...
        scenario.coLocatedAccessAperture === true
        ? [{
    ...
    ...(scenario.mechanism === "fixed-top-frame" ? [
      ...(scenario.coLocatedAccessAperture === true ? [] : [item({
