...
export const CURRENT_INTENT_SCHEMA_ID = "intent-graph-v2@2.1.0" as const;
export const CURRENT_SEMANTIC_REQUEST_VERSION = "semantic-generation-request-v2" as const;
